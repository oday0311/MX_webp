...
#if 0
#include <stdio.h>
static MV_WEBP_INLINE void PrintReg(const __m128i r, const char* const name,
                                 int size) {
  int n;
  union {
    __m128i r;
...
static MV_WEBP_INLINE int VP8HorizontalAdd8b(const __m128i* const a) {
...
static MV_WEBP_INLINE void VP8Transpose_2_4x4_16b(
